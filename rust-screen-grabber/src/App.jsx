  ...
  //const [operationInProgress, setOperationInProgress] = useState(false);
    ...
    return (
            ...
            <Button style={{zIndex: "3", position:"absolute", top: "0.5rem", right: "0.5rem"}} variant={"light"} className={"mx-2"}
                ...
                <Container className="background-container p-0 mt-2"></Container>
                        ...
                        <Container className={"flex-row align-items-center p-0"}>
                            ...
                            <Container className={"d-flex flex-column align-items-center p-0 justify-content-center p-0 mx-2 w-auto"}>
                                ...
                                <Container className={"d-flex flex-row p-0"}>
                                    <Button className={"m-1"} variant={mode === "capture" && view === "fullscreen" ? "success" : "outline-success"}
                                            disabled={capturing}
                                    ...
                                    <Button className={"m-1"} variant={mode === "capture" && view === "custom" ? "success" : "outline-success"}
                            ...
                            <Container className={"d-flex flex-column align-items-center justify-content-center p-0 mx-2 w-auto"}>
                                ...
                                <Container className={"d-flex flex-row p-0"}>
                                    <Button title={"Record Entire Screen"} className={"m-1"}
                                            disabled={capturing}
                                            variant={mode === "record" && view === "fullscreen" ? "warning" : "outline-warning"}
                                    ...
                                    <Button
                                        className={"m-1"}
                                        variant={mode === "record" && view === "custom" ? "warning" : "outline-warning"}
                            ...
                            <Container className={"d-flex flex-column align-items-center justify-content-center p-0 mx-2 w-auto"}>
                                <FormText>&nbsp;</FormText>
                                { countdown > 0 ? <Button className={"m-1"} variant={"warning"} onClick={stopCapture}>Cancel</Button> :
                                    mode==="record" && capturing ? <Button className={"blink m-1"} variant={"warning"} onClick={stopCapture}>Stop</Button> :
                                        (mode !== undefined && view !== undefined) ? <Button className={"m-1"} variant={mode === "capture" ? "success" : "warning"} onClick={async () => await capture(mode, view, duration, pointer, filePath, mode==="capture" ? captureType : recordType, clipboard, openFile)}>{mode[0].toUpperCase() + mode.slice(1)}</Button> : false}
                            </Container>
