            ...
            <Container className={"flex-row justify-content-center p-0 m-0 w-100"}>
                ...
                <Container style={{zIndex: "2", position: "relative"}} className={"w-100 align-items-center p-1"}>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        {duplicateHotkey && <p className="text-warning">This hotkey combination is already used by another command!</p>}
                        <Button className={"m-3"} variant={"outline-warning"} onClick={async () => await invoke("close_hotkeys", {})}>Cancel</Button>
